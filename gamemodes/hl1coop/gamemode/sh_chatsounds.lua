local chatsounds = {
	...
	["freeze"] = {true, "barney/ba_attack1.wav"},
	...
	["freeman you fool"] = "scientist/c3a2_sci_fool.wav",
	...
	["good to see you"] = "scientist/goodtoseeyou.wav",
	...
	["something burning"] = "scientist/smellburn.wav",
	["stench"] = "scientist/stench.wav",
	["hold still"] = "scientist/holdstill.wav",
	...
	["grand unification boys"] = "scientist/shakeunification.wav",
	["it's rather stimulating"] = "scientist/stimulating.wav",
	["test chamber"] = "scientist/c1a0_sci_ctrl4a.wav",
	["about to go critical"] = "scientist/c1a0_sci_crit1a.wav",
	["not yet freeman"] = "scientist/c3a2_sci_notyet.wav",
	...
	["ohh"] = {true, "scientist/sci_fear10.wav"},
	["ooh"] = {true, "scientist/sci_fear3.wav"},
	...
	["aaaa"] = {"scientist/scream14.wav", "scientist/sci_fear8.wav", "scientist/sci_fear15.wav"},
	...
	["hurry up"] = {"hl1chatsounds/hurryup.wav", "hl1chatsounds/hurryup1.wav"},
	...
	["are you insane"] = "hl1chatsounds/areyouinsane.wav",
	["are you crazy"] = "hl1chatsounds/areyoucrazy.wav",
	["wait a minute"] = "hl1chatsounds/waitaminute.wav",
	["hiding spot"] = "hl1chatsounds/hidingspot.wav",
	["did you see it"] = "hl1chatsounds/didyouseeit.wav",
	["thank you mr freeman"] = "hl1chatsounds/thankyoufreeman.wav",
	["stop attacking"] = "hl1chatsounds/stopattacking.wav",
	-- decay
	["interesting"] = "scientist/d01_sci10_interesting.wav",
	["that shouldn't happen"] = "scientist/d01_sci11_shouldnthappen.wav",
	["theoretically this is impossible"] = "scientist/d01_sci12_impossible.wav",
	["hello ladies"] = "scientist/helloladies.wav",
	["i can help"] = "scientist/icanhelp.wav",
	["perfume"] = "scientist/perfume.wav",
	["that smell is interesting"] = "scientist/thatsmell.wav",
	["sniff"] = {true, "scientist/sniffle.wav"},
	["yawn"] = {true, "scientist/yawn.wav"},
	...
	-- otis
	["mmmm"] = "otis/mmmm.wav",
	["candy"] = "hl1chatsounds/candy.wav",
	["hey soldier"] = "otis/hey.wav",
	["yeah sure"] = "otis/yeah.wav",
	["yeah aha"] = "otis/yes.wav",
	
	--op4/tfc
	["ass"] = {true, "fgrunt/ass.wav"},
	["take cover"] = {true, "fgrunt/takecover.wav"},
...
if CLIENT then
	...
	function GM:PlayerCanChatsound(ply)
		return ply:Alive() or ply:Team() == TEAM_UNASSIGNED
	end

	function GM:PlayerSayChatsound(ply, text, isTeamChat)
		if cvar_sv_chatsounds:GetBool() then
			if hook.Run("PlayerCanChatsound", ply) and (!ply.NextChatsoundTime or ply.NextChatsoundTime <= CurTime()) then
				local sound = nil
				...
				if sound then
					...
					if !game.SinglePlayer() then
						local pitchPct = 100 / pitch
						local sndDur = SoundDuration(sound)
						if !sndDur or sndDur <= 0 then
							sndDur = 1.5
						end
						ply.NextChatsoundTime = CurTime() + .5 + sndDur * pitchPct
					end
				end
			end
		end
